   ...
   var st = $('#search_type').val();
    var table = $('#member-table').DataTable({
      ...
      "processing": false,
        ...
        "pageLength" : 15,
        buttons: [
          { "extend": 'copy', "text":'<?php echo lang("ctn_756") ?>',"className": 'btn btn-default btn-sm' },
          { "extend": 'csv', "text":'<?php echo lang("ctn_757") ?>',"className": 'btn btn-default btn-sm' },
          { "extend": 'excel', "text":'<?php echo lang("ctn_758") ?>',"className": 'btn btn-default btn-sm' },
          { "extend": 'pdf', "text":'<?php echo lang("ctn_759") ?>',"className": 'btn btn-default btn-sm' },
          { "extend": 'print', "text":'<?php echo lang("ctn_760") ?>',"className": 'btn btn-default btn-sm' }
        ],
        "serverSide": true,
        "orderMulti": false,
        "order": [
