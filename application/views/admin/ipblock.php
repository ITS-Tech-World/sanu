...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <input type="button" class="btn btn-post btn-sm" value="<?php echo lang("ctn_65") ?>" data-toggle="modal" data-target="#ipModal" />
</div>
</div>
...
<tr><td><?php echo $r->IP ?></td><td><?php echo $r->reason ?></td><td><?php echo date($this->settings->info->date_format, $r->timestamp) ?></td><td><a href="<?php echo site_url("admin/delete_ipblock/" . $r->ID) ?>" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_57") ?>"><span class="glyphicon glyphicon-trash"></span></a></td></tr>
<?php endforeach; ?>
</table>
